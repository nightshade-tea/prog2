...
static unsigned int
_LZ_StringCompare (unsigned char *str1, unsigned char *str2,
...
static int
_LZ_WriteVarSize (unsigned int x, unsigned char *buf)
{
  unsigned int y;
  int num_bytes, i, b;
...
static int
_LZ_ReadVarSize (unsigned int *x, unsigned char *buf)
{
...
int
LZ_Compress (unsigned char *in, unsigned char *out, unsigned int insize)
{
...
int
LZ_CompressFast (unsigned char *in, unsigned char *out, unsigned int insize,
                 unsigned int *work)
{
  unsigned char marker, symbol;
...
void
LZ_Uncompress (unsigned char *in, unsigned char *out, unsigned int insize)
{
  unsigned char marker, symbol;
